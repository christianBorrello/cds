...
/* Create a new empty stack with elements of the given size in bytes
 *
...
/* Remove all elements from the stack without destroying it
 *
...
/* Returns: true if the stack is empty or s is NULL, false otherwise */
bool cds_stack_empty(const cds_stack *s);

/* Returns: the number of elements in the stack, or 0 if s is NULL */
...
/* Push a copy of value onto the top of the stack
 *
...
/* Remove the top element and optionally copy it into out
 *
